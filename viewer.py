...
class MainApp:
    def __init__(self, viewer, dataset_path):
        ...
        self.imhandler = ImageHandler(viewer, self.dataset, self.mil, self._update_mil_references)
    ...
    def _update_mil_references(self, new_mil):
        self.mil = new_mil
        self.multilabeler.mil = new_mil
